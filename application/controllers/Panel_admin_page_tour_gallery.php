...
//      adminin icindeki papkanin adi
        $this->view_folder = "tour_gallery";

//      tablemizin adi
        $this->table_name = "tour_gallery";

//      sekilleri ve fayllari yukleyeceyimiz yer meselen: base_url("uploads/teachers/")
        $this->upload_path = "uploads/tour_gallery/";
...
//      data tablenin icine melumatlarin ajaxnan getirilmesi ucun lazim olan link
    ...
    public function get_data()
    {
        ...
        $tour_image_ids = $this->Core->get_where_result_desc(array("tour_id" => $this->session->userdata("c")), "tour_gallery");
        $id_array = [];
    ...
    public function add($id)
    {
        ...
        $config['upload_path'] = "uploads/tour_gallery";
    ...
    public function delete($id)
    {
        ...
        $config["success_link"] = base_url("panel_admin_page_tour_gallery/index/$tour_id");
        $config["error_link"] = base_url("panel_admin_page_tour_gallery/index/$tour_id");
        $config["upload_path"] = $this->upload_path;
        $config["table_name"] = $this->table_name;
