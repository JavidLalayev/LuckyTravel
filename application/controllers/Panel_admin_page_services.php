...
class Panel_admin_page_services extends MY_Controller{
...
//      tablemizin fieldlerinin array icinde siralanmasi BU DEYISILMIR!
        ...
        $this->label_name_and_input_name = array(
            "Servisin Adı Az" => "(group1)name_az(required)",
            "Servisin Adı En" => "(group1)name_en(required)",
            "Servisin Adı Ru" => "(group1)name_ru(required)",

            "Servisin Başlıqı Az" => "(group1)title_az(required)",
            "Servisin Başlıqı En" => "(group1)title_en(required)",
            "Servisin Başlıqı Ru" => "(group1)title_ru(required)",

            "Servis Haqqında Az" => "(group2)desc_az",
            "Servis Haqqında En" => "(group2)desc_en",
            "Servis Haqqında Ru" => "(group2)desc_ru",
...
//      tabledeki melumatlarin add olunduqu link
        $this->add_link                       = base_url("Panel_admin_page_services/add/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez

//      tabledeki melumatlarin delete olunduqu link
        $this->delete_link                    = base_url("Panel_admin_page_services/delete/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez

//      ajaxnan melumatlarin modalin icine getirilmesi
        $this->link_for_update_modal          = base_url("Panel_admin_page_services/get_data_for_update/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez

//      proseslerden her hansi biri ugurla basa catdiqda hansi linke atsin
        $this->success_link                   = base_url("Panel_admin_page_services/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez

//      proseslerden her hansi biri ugurla basa catmadiqda hansi linke atsin
        $this->error_link                     = base_url("Panel_admin_page_services/");//bunnarin sonuna slash qoymaq vacibdir yoxsa islemez

//      data tablenin icine melumatlarin ajaxnan getirilmesi ucun lazim olan link
        $this->get_data_link                  = base_url("Panel_admin_page_services/get_data");
    }
