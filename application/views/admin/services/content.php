...
<section>
    ...
    <div class="card card-cascade narrower z-depth-0 pb-4">
        ...
        <div
            ...
            <a class="white-text mx-3">Xidmətlər</a>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-hover table-bordered mb-0" id="datatable" data-url="<?php echo $get_data_link?>">
                    ...
                    <tr>
                        ...
                        <th data-orderable="true" class="c_th_max_width"><a>Servisin Adı Az<i class="fas fa-sort ml-1"></i></a></th>
                        <th data-orderable="true" class="c_th_max_width"><a>Servisin Adı En<i class="fas fa-sort ml-1"></i></a></th>
                        <th data-orderable="true" class="c_th_max_width"><a>Servisin Adı Ru<i class="fas fa-sort ml-1"></i></a></th>
